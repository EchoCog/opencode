...
import { useKeyboard, useKeyHandler } from "@opentui/solid"
...
function Option(props: { id: string, title: string, description?: string, active?: boolean, current?: boolean }) {
  return (
    <box
      id={props.id}
      flexDirection="row" backgroundColor={props.active ? Theme.primary : RGBA.fromInts(0, 0, 0, 0)} paddingLeft={1} paddingRight={1}>
